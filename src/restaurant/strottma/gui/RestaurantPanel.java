...
public class RestaurantPanel extends JPanel {
    ...
    public RestaurantPanel(RestaurantGui gui) {
        ...
        setLayout(new GridLayout(LAYOUT_ROWS, LAYOUT_COLUMNS, LAYOUT_HGAP,
        		LAYOUT_VGAP));
//        group.setLayout(new GridLayout(GROUP_LAYOUT_ROWS, GROUP_LAYOUT_COLUMNS,
//        		GROUP_LAYOUT_HGAP, GROUP_LAYOUT_VGAP));
...
//        add(group);
        ...
        // TODO Remove this hack when adding waiters and customers works
//        addPerson("Waiters", "Squidward");
//        addPerson("Customers", "Patrick");
//        customers.get(0).gotHungry();
    }
