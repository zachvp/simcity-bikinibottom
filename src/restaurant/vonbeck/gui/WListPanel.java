...
public class WListPanel extends JPanel implements ActionListener {
     ...
     */
    public WListPanel(RestaurantPanel rp, String type) {
        restPanel = rp;
        this.type = type;
    ...
    public void addPerson(String name) {
        if (name != null) {
        	if (list.size() < 7) {
    			...
    			System.out.println("Can't add another waiter, too many of them");
    		}
        }
    }
}
